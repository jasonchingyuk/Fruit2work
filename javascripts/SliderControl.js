L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
		...
		this._layer.eachLayer(function (layer) {
            ...
            if( flags[layer.feature.properties.group]) return;
            flags[layer.feature.properties.group] = true;
            unique_values.push(layer.feature.properties.group);
            ++len;
        });
		var all_features = [];
        ...
        for(var i=0;i<layers.length;i++){
            ...
            var index = unique_values.indexOf(layers[i].feature.properties.group)
            //console.log(index);
	...
	onRemove: function (map) {
		...
		for (i = this.options.minValue; i < this.options.maxValue; i++) {
			...
			console.log(this.options.minValue);
			console.log(this.options.maxValue);
		}
